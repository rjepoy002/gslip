<!-- =========================================================
     SECONDARY APPROVER MODAL
========================================================= -->
<div
    class="modal fade"
    id="secondaryApproverModal"
    tabindex="-1"
    aria-hidden="true"
>
                    ...
                    <table class="styled-table excel-table approval-table mb-0">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($users as $userRow): ?>
                                ...
                                // Cannot select the Primary Approver
                                if (
                                    $primaryApproverId !== null &&
                                    (int)$userRow['id'] ===
                                    (int)$primaryApproverId
                                ) {
                                    continue;
                                }
                                ...
                                <tr
                                    class="select-secondary-approver modal-select-row"
