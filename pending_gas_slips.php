...
const result = await Swal.fire({
    ...
    inputPlaceholder: 'Enter the reason for rejecting this gas slip...',
    inputAttributes: {
...
const gasSlipInput = document.createElement('input');
gasSlipInput.type = 'hidden';
gasSlipInput.name = 'gas_slip_id';
gasSlipInput.value = gasSlipId;
