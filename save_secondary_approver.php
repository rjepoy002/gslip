...
if ($result->num_rows > 0) {
    ...
    echo json_encode([
        'success' => false,
        'message' => 'Recommender cannot be secondary approver.'
    ]);
...
if ($result->num_rows > 0) {
    ...
    echo json_encode([
        'success' => false,
        'message' => 'Primary approver cannot also be secondary approver.'
    ]);
...
try {
    ...
    echo json_encode([
        'success' => true,
        'message' => 'Secondary approver updated.'
    ]);
